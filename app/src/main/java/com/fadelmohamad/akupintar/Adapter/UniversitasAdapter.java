package com.fadelmohamad.akupintar.Adapter;
...
import com.fadelmohamad.akupintar.View.HalamanDetailActivity;
...
public class UniversitasAdapter extends RecyclerView.Adapter<UniversitasAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.activity_list_universitas, viewGroup, false);
